...
const WebsiteControlCenter = ({ onBack }) => {
  ...
  const { homepageConfig, updateHomepageConfig } = useHomepageConfig();

  // For backward compatibility, map context data to homepageData
  const homepageData = homepageConfig;
  const handleHomepageDataChange = updateHomepageConfig;
      ...
      case "about":
        return (
          <Card className="p-6">
            ...
            <p className="text-gray-600">
              About page content management will be implemented here.
            </p>
          </Card>
        );
      case "contact":
        return (
          <Card className="p-6">
            ...
            <p className="text-gray-600">
              Contact page content management will be implemented here.
            </p>
          </Card>
        );
      case "privacy":
        return (
          <Card className="p-6">
            ...
            <p className="text-gray-600">
              Privacy Policy content management will be implemented here.
            </p>
          </Card>
        );
      case "terms":
        return (
          <Card className="p-6">
            ...
            <p className="text-gray-600">
              Terms of Service content management will be implemented here.
            </p>
          </Card>
        );
      case "support":
        return (
          <Card className="p-6">
            ...
            <p className="text-gray-600">
              Support page content management will be implemented here.
            </p>
          </Card>
        );
      default:
