  ...
  const dataTypes = [
    {
      ...
      purpose: "Platform access and personalization",
      retention: "Active account duration",
    },
    {
      type: "Business Listings",
      purpose: "Service discovery and bookings",
      retention: "Business account duration",
    },
    {
      type: "Reviews & Ratings",
      purpose: "Community trust and quality",
      retention: "Permanent (anonymized)",
    },
    {
      type: "Transaction Data",
      purpose: "Payment processing and records",
      retention: "7 years",
    },
    {
      type: "Usage Analytics",
      purpose: "Platform improvement",
      retention: "3 years (aggregated)",
    },
    {
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-primary-100 max-w-3xl mx-auto mb-8">
              ...
              collect, use, and protect your personal information on Easy Life
              Gangtok.
            </p>
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="border-b border-gray-200">
                    <th className="pb-3 text-gray-900 font-semibold">
                      Data Type
                    </th>
                    <th className="pb-3 text-gray-900 font-semibold">
                      Purpose
          ...
          >
            ...
            <div className="mt-12 pt-8 border-t border-gray-200">
              ...
              <p className="text-gray-600">
                Easy Life Gangtok is committed to maintaining the highest
                standards of data protection and privacy. We regularly audit our
                practices to ensure compliance with international privacy laws.
              </p>
            </div>
          </motion.div>
        </div>
