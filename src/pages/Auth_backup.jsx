...
const Auth = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    confirmPassword: "",
    userType: "customer",
    businessType: "", // New field for business type selection
    otp: "",
  ...
  const renderSignupForm = () => (
    ...
    >
      <div className="space-y-5">
            ...
            >
              ...
              <div className="flex-1">
                <div className="flex items-center">
                  ...
                  <span className="font-medium text-gray-900">Business Partner</span>
                </div>
        ...
        {formData.userType === "seller" && !formData.businessType && (
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <button
                type="button"
                onClick={() => setFormData(prev => ({ ...prev, businessType: "bike-rider" }))}
              ...
              <button
                type="button"
                onClick={() => setFormData(prev => ({ ...prev, businessType: "taxi-service" }))}
              ...
              >
                ...
                <h4 className="font-semibold text-gray-900 mb-1">Taxi Service</h4>
        ...
        {formData.userType === "customer" ? (
        ...
        ) : formData.userType === "seller" && formData.businessType === "product" ? (
          ...
          <>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                {["Electronics", "Clothing", "Home & Garden", "Books", "Sports", "Food & Beverages"].map(category => (
                  <label key={category} className="flex items-center space-x-2">
                    <input
                      ...
                      onChange={(e) => {
                        if (e.target.checked) {
                          setFormData(prev => ({ ...prev, productCategories: [...prev.productCategories, category] }));
                        } else {
                          setFormData(prev => ({ ...prev, productCategories: prev.productCategories.filter(c => c !== category) }));
                        }
                      }}
            ...
            <div className="flex justify-center mt-6">
              <Button
                type="button"
                onClick={() => setFormData(prev => ({ ...prev, businessType: "" }))}
                variant="outline"
                className="flex items-center gap-2"
              >
                <ArrowLeft className="w-4 h-4" />
        ...
        ) : formData.userType === "seller" && formData.businessType === "service" ? (
          ...
          <>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                {["Plumbing", "Electrical", "Cleaning", "Repair", "Maintenance", "Consultation"].map(service => (
                  <label key={service} className="flex items-center space-x-2">
                    <input
                      ...
                      onChange={(e) => {
                        if (e.target.checked) {
                          setFormData(prev => ({ ...prev, serviceTypes: [...prev.serviceTypes, service] }));
                        } else {
                          setFormData(prev => ({ ...prev, serviceTypes: prev.serviceTypes.filter(s => s !== service) }));
                        }
                      }}
                      className="rounded border-gray-300"
                    />
        ...
        ) : formData.userType === "seller" && formData.businessType === "bike-rider" ? (
          // Bike Rider Fields
          <>
        ...
        ) : formData.userType === "seller" && formData.businessType === "taxi-service" ? (
          // Taxi Service Fields
          <>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                {["Sedan", "SUV", "Hatchback", "Luxury", "Mini Van", "Tempo Traveller"].map(vehicle => (
                  <label key={vehicle} className="flex items-center space-x-2">
                    <input
                      ...
                      onChange={(e) => {
                        if (e.target.checked) {
                          setFormData(prev => ({ ...prev, vehicleTypes: [...prev.vehicleTypes, vehicle] }));
                        } else {
                          setFormData(prev => ({ ...prev, vehicleTypes: prev.vehicleTypes.filter(v => v !== vehicle) }));
                        }
                      }}
                      className="rounded border-gray-300"
                    />
          ...
          <div className="text-center text-gray-500">
            <p>Business type not supported yet</p>
          </div>
        ) : null}
            />
            <Input
